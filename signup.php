...
$UIN = $password = $email = $UIN_err = $password_err = $email_err = "";
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($UIN_err) && empty($password_err) && empty($email_err)){
			...
			<div class="wrap-login100">
				<form  action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post" class="login100-form validate-form">
					...
					<div class="wrap-input100 validate-input">
						<input name="UIN"  class="input100" type="text">
